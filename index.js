...
express()
  ...
  .get("/get_student", studentController.getStudentById)
  .get('/edit_student', (req, res) => res.render('pages/edit_student'))
  .get("/edit_this_student", studentController.editStudent)
  .get("/delete_student", studentController.deleteStudent)
  //.get("/edit_student", studentController.getStudentById)
  ...
  .get("/add_accommodation",  (req, res) => res.render('pages/add_accommodation'))
  .get("/edit_accommodation",  (req, res) => res.render('pages/edit_accommodation'))
  .get("/get_accommodation_by_student", accommodationController.getAccommodationsByStudent)
  .get("/edit_this_accommodation", accommodationController.editAccommodation)

    .get("/search_accommodations",  (req, res) => res.render('pages/search_accommodations'))
  //.get("/edit_this_accommodation", accommodationController.getAccommodationsByStudent)
